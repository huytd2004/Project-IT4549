...
const MedicalForm = () => {
    ...
    // phần chuẩn đoán chung
    const CHUAN_DOAN_CHUNG_LIST = [
        "Tiêu hóa", "Da liễu", "Hô hấp", "Cơ Sương Khớp", "Nhiễm Trùng",
        "Dinh Dưỡng Kém", "Béo Phì", "Thiếu Cân", "Tâm Lý", "Ký Sinh Trùng", "Vệ Sinh Răng Miệng"
    ];
    ...
    const handleSubmit = async () => {
        ...
        console.log("📦 Dữ liệu chuẩn bị gửi:", newRecord); // Thêm dòng log
        ...
        <Box p={4} display="flex" gap={4}>
            ...
            <Box flex={1}>
                ...
                <Box display="flex" flexDirection="column" gap={2} mt={3}>
                    ...
                    <Typography variant="h6" mt={2}>Chẩn đoán chung</Typography>
